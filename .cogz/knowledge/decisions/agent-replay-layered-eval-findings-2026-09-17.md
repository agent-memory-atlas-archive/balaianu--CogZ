...
title: "Agent-replay layered A/B evaluation: causal evidence for context-pack value and the delivery-model decision"
type: knowledge
status: active
created_at: "2026-09-17T10:00:00Z"
updated_at: "2026-09-21T13:53:58.577878052+00:00"
references: []
category: decisions
...
# Agent-replay layered A/B evaluation findings

First agent-in-the-loop causal measurement of CogZ context packs. 14 historical
tasks replayed from a production repository's commit history, three arms: bare (no cogz), cogz (full tiered push),
